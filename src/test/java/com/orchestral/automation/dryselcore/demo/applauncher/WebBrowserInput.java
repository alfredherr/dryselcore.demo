...
public class WebBrowserInput extends TestObjectHelper<TestDatum> {

	@Override
	public void addTestObjects() {
		// create input test datum for address bar
		this.testObjects.add(new TestDatum(1, "address", "http://localhost:3000"));
	}
}
