 ...
 */
package com.orchestral.automation.dryselcore.demo.applauncher;

import com.orchestral.automation.dryselcore.eventlib.OpenURL;
...
public class WebBrowserUI extends TestObjectHelper<UIElement> {

	@Override
	public void addTestObjects() {
		// add UI element to the list of UI Elements
		this.testObjects.add(new UIElement("address", "addressBar", new OpenURL(), null));
	}
}
